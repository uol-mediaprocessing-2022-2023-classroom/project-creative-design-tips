...
# Disclaimer
#
# This file was initially created by https://github.com/zhixuhao/unet and not modified
###############################
...
class myAugmentation(object):
	...
	def doAugmentate(self, img, save_to_dir, save_prefix, batch_size=1, save_format='tif', imgnum=68):
